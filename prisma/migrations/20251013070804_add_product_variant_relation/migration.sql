...
CREATE TABLE "new_ab_test_variants" (
    ...
    CONSTRAINT "ab_test_variants_abTestProductId_fkey" FOREIGN KEY ("abTestProductId") REFERENCES "ab_test_products" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
